#-------------------------------------------------------------------------------
# Exer_8_neural_network_second_program_lv.py
# This project use neural networks with hyperparameter tuning for a holiday
# rental consumer segmentation dataset and generate classification reports
